...
python3 generate_fast_tree_phylogenies.py --a3m_dir "$a3m_dir" --outdir "$tree_dir" --n_process "$n_process" --expected_number_of_MSAs "$expected_number_of_MSAs" --max_seqs "$max_seqs" --max_sites "$max_sites" --max_families "$max_families"
