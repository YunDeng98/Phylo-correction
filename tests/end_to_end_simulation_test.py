...
class TestEndToEndSimulation(unittest.TestCase):
    ...
    def test_shared_cache(self):
        ...
        def run_experiment_and_return_learned_rate_matrices(
            ...
            fast_tree_cats_end_to_end=20,
            use_site_specific_rates_end_to_end=False,
            ...
            end_to_end_simulator = EndToEndSimulator(
                ...
                fast_tree_cats=fast_tree_cats_end_to_end,
                use_site_specific_rates=use_site_specific_rates_end_to_end,
    ...
    # Commenting this out because we are not using XRATE any more.
    # @pytest.mark.slow
