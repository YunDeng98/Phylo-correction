...
def get_registered_models() -> List[Tuple[str, Optional[str], Optional[str]]]:
    ...
    return [
        ...
        ("LG reproduced (with XRATE), init JTT-IPW; 2nd it.", None, "./input_data/Q2XRATE_SR.PAML.txt"),
        ("LG reproduced (with XRATE), init WAG", None, "./input_data/Q1XRATE_SR_init_WAG.PAML.txt"),
        ("LG reproduced (with XRATE), init WAG; 2nd it.", None, "./input_data/Q2XRATE_SR_init_WAG.PAML.txt"),
        ("LG reproduced (with XRATE), init WAG, more EM", None, "./input_data/Q1XRATE_SR_init_WAG_mininc_0_0001.PAML.txt"),
