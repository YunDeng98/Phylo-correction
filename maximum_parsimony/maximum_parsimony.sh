...
python3 maximum_parsimony.py --a3m_dir "$a3m_dir" --tree_dir "$tree_dir" --outdir "$maximum_parsimony_dir" --n_process "$n_process" --expected_number_of_MSAs 15051 --max_families 10000000
